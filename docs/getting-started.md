...
- Preview the complete retained guild-blueprint manifest locally before live planning, then distinguish freshly assessed entries from deferred intent and execute only the one named frontier
