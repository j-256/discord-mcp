...
export const ENVIRONMENT_NAMES = Object.freeze({
  ...
  allowChannelDeletionAudit: "DISCORD_MCP_ALLOW_CHANNEL_DELETION_AUDIT",
  allowChannelDeletions: "DISCORD_MCP_ALLOW_CHANNEL_DELETIONS",
  ...
  allowNicknameChanges: "DISCORD_MCP_ALLOW_NICKNAME_CHANGES",
  allowOtherMemberNicknameChanges: "DISCORD_MCP_ALLOW_OTHER_MEMBER_NICKNAME_CHANGES",
  ...
  allowRoleDeletionAudit: "DISCORD_MCP_ALLOW_ROLE_DELETION_AUDIT",
  allowRoleDeletions: "DISCORD_MCP_ALLOW_ROLE_DELETIONS",
  allowRoleOrderingAudit: "DISCORD_MCP_ALLOW_ROLE_ORDERING_AUDIT",
  allowRoleOrderingChanges: "DISCORD_MCP_ALLOW_ROLE_ORDERING_CHANGES",
  allowScheduledEventAudit: "DISCORD_MCP_ALLOW_SCHEDULED_EVENT_AUDIT",
  allowScheduledEventUserAudit: "DISCORD_MCP_ALLOW_SCHEDULED_EVENT_USER_AUDIT",
  ...
  channelDeletionIds: "DISCORD_MCP_CHANNEL_DELETION_IDS",
  ...
  configFile: "DISCORD_MCP_CONFIG_FILE",
  ...
  nicknameGuildIds: "DISCORD_MCP_NICKNAME_GUILD_IDS",
  ...
  roleDeletionIds: "DISCORD_MCP_ROLE_DELETION_IDS",
  roleOrderingGuildIds: "DISCORD_MCP_ROLE_ORDERING_GUILD_IDS",
