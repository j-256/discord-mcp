...
function toolMarkup(
  ...
  const search = [
    ...
    metadata.access.guidance.impact,
    metadata.access.guidance.impactLabel,
    metadata.access.guidance.impactSummary,
    metadata.access.guidance.preferredNextTool,
    metadata.access.guidance.reviewRequirement,
    metadata.access.guidance.workflowRole,
