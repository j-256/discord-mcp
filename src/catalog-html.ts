...
<body>
  ...
  <header class="shell hero">
    ...
    <div class="guarantees">
      <section class="panel"><h2>What this proves</h2><ul class="checks"><li>Production registrations negotiated</li><li>Complete tool annotations checked</li><li>Known and unknown calls blocked identically</li><li>Policy completion routes return zero catalog IDs</li><li>Static safety guidance fingerprinted</li><li>No credential or Discord execution available</li></ul></section>
  ...
  <nav class="sticky-nav" aria-label="Contract sections"><div class="shell nav-inner"><a href="#tools">Tools</a><a href="#prompts">Prompts</a><a href="#completions">Completions</a><a href="#resources">Resources</a><a href="#instructions">Instructions</a><a href="#safety">Safety</a></div></nav>
