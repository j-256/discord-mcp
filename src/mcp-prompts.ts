    ...
    ({ requestJson }) => userPrompt(
      promptText(
        ...
        [
          ...
          "3. Present the verified application, bot, guild, fixed structure, profile, settings, Welcome Screen, and onboarding phase order, exact current frontier, symbolic-to-exact resource bindings, nested domain plan, phase-separated operation hashes, caller-retained request digest, privacy boundary, warnings, creation time, and aggregate keyed plan digest for review.",
          "4. Treat any domain scope, identity, permission, hierarchy, capacity, conflict, uncertainty, drift, spent operation binding, unresolved scaffold channel or role reference, or changed request digest as a blocker.",
