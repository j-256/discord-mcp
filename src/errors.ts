...
export class BotInstallationAuditEvidenceError extends Error {
  override name = "BotInstallationAuditEvidenceError"
}
...
export class CommunityActivityEvidenceError extends ConfigurationError {
...
export class WriteCoordinationConflictError extends Error {
  ...
  constructor(claimId: string) {
    super(
      `Reviewed Discord write claim ${claimId} already owns at least one required target; inspect it with guildctl coordination list`,
    )
...
export class WriteCoordinationQuarantinedError extends Error {
  ...
  constructor(claimId: string, options?: ErrorOptions) {
    super(
      `Reviewed Discord write claim ${claimId} is quarantined because its outcome is not safely settled; inspect Discord and run guildctl coordination list`,
      options,
    )
