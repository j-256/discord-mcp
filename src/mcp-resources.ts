    ...
    async (uri) => ({
      contents: [{
        ...
        text: [
          ...
          "",
          "Receipt-backed single-step reviewed writes acquire durable exact target claims before the final fresh plan advances. Connector processes coordinate only when they share one canonical local activity-state root on a local filesystem. Claims never expire by age; terminal or absent matching receipts permit safe dead-owner recovery, while pending, uncertain, unreadable, or malformed evidence remains quarantined for exact operator review. Guild scaffolds, legacy deletion and member moderation, and ordinary message interactions retain their separate documented semantics.",
          "",
