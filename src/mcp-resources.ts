    ...
    async (uri) => jsonResource(
      ...
      () => ({
        ...
        warnings: [
          ...
          "Starters express category order and each multi-channel parent group as symbolic top-to-bottom chains without reparenting acknowledgement",
          ...
          "Private staff areas, role authority, Community, onboarding, AutoMod, publications, and exact existing-resource metadata or permission convergence are deliberately omitted",
          ...
          "Customize and retain the returned exact request, preview its complete intent locally, then use the ordinary reviewed one-frontier blueprint lifecycle",
        ],
      }),
      0,
    ),
