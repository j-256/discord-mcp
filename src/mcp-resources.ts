    ...
    async (uri) => ({
      contents: [{
        ...
        text: [
          ...
          "",
          "Deletion, member moderation, and bulk guild bans are review-first workflows. Planning is read-only. Execution remains a separate destructive tool and requires every configured policy, freshness, signed-state, approval, confirmation, and audit gate.",
        ].join("\n"),
        uri: uri.href,
      }],
    }),
