...
export const MCP_RESOURCE_NAMES = Object.freeze({
  ...
  coordinationPlaybook: "coordination_playbook",
  defaultSoundboard: "default_soundboard_sounds",
  guildBlueprintStarters: "guild_blueprint_starters",
  guilds: "scoped_guilds",
  gatewayEvents: "gateway_events",
  gatewayStatus: "gateway_status",
  nativeInteractionContinuations: "native_interaction_continuations",
...
export const MCP_RESOURCE_URIS = Object.freeze({
  ...
  componentTemplates: "discord://connector/component-templates",
  coordinationPlaybook: "discord://connector/coordination",
  defaultSoundboard: "discord://soundboard/defaults",
  guildBlueprintStarters: "discord://connector/guild-blueprint-starters",
  guilds: "discord://guilds",
  gatewayEvents: "discord://gateway/events",
  gatewayStatus: "discord://gateway/status",
  nativeInteractionContinuations: "discord://interactions/continuations",
...
export const MCP_RESOURCE_TEMPLATE_NAMES = Object.freeze({
  ...
  guildCommunity: "guild_community",
  ...
  guildVanityUrl: "guild_vanity_url",
...
export const MCP_RESOURCE_TEMPLATE_URIS = Object.freeze({
  ...
  messageAttachment: "discord://channels/{channelId}/messages/{messageId}/attachments/{attachmentId}",
  messageReactions: "discord://channels/{channelId}/messages/{messageId}/reactions",
  toolAccess: "discord://connector/tool-access/{toolName}",
  ...
  guildCommunity: "discord://guilds/{guildId}/community",
...
export const MCP_PROMPT_NAMES = Object.freeze({
  ...
  inspectDiscordCoordinationTask: "inspect_discord_coordination_task",
  inspectGuildBan: "inspect_guild_ban",
  prepareGuildRecovery: "prepare_guild_recovery",
  recallConversation: "recall_discord_conversation",
  ...
  reviewGuildApplicationCommandChange: "review_guild_application_command_change",
  reviewGlobalApplicationCommandChange: "review_global_application_command_change",
  ...
  reviewGuildCommunityChange: "review_guild_community_change",
  ...
  reviewEmbedMessage: "review_embed_message",
  ...
  reviewChannelPermissionSync: "review_channel_permission_sync",
  reviewDirectMessageChange: "review_direct_message_change",
  ...
  reviewGuildDeparture: "review_guild_departure",
  reviewGuildWebhooks: "review_guild_webhooks",
  ...
  reviewBulkMemberRoleChange: "review_bulk_member_role_change",
  ...
  reviewMemberVerificationChange: "review_member_verification_change",
  ...
  reviewPollCreation: "review_poll_creation",
  reviewPollEnd: "review_poll_end",
...
export const MCP_PROMPT_TOOLSETS = Object.freeze({
  ...
  [MCP_PROMPT_NAMES.inspectDiscordCoordinationTask]: "messages",
  [MCP_PROMPT_NAMES.inspectGuildBan]: "bans",
  [MCP_PROMPT_NAMES.prepareGuildRecovery]: "guild-blueprints",
  ...
  [MCP_PROMPT_NAMES.reviewGuildApplicationCommandChange]: "application-commands",
  [MCP_PROMPT_NAMES.reviewGlobalApplicationCommandChange]: "application-commands",
  ...
  [MCP_PROMPT_NAMES.reviewGuildCommunityChange]: "guild-community",
  ...
  [MCP_PROMPT_NAMES.reviewEmbedMessage]: "embed-messages",
  ...
  [MCP_PROMPT_NAMES.reviewChannelPermissionSync]: "permission-sync",
  [MCP_PROMPT_NAMES.reviewDirectMessageChange]: "direct-messages",
  ...
  [MCP_PROMPT_NAMES.reviewGuildDeparture]: "guild-departure",
  [MCP_PROMPT_NAMES.reviewGuildWebhooks]: "webhooks",
  ...
  [MCP_PROMPT_NAMES.reviewBulkMemberRoleChange]: "member-roles",
  ...
  [MCP_PROMPT_NAMES.reviewMemberVerificationChange]: "member-verification",
  ...
  [MCP_PROMPT_NAMES.recallConversation]: "messages",
  ...
  [MCP_PROMPT_NAMES.reviewPollCreation]: "polls",
  [MCP_PROMPT_NAMES.reviewPollEnd]: "polls",
