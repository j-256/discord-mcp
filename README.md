...
| `list_activity` | Local read | Read content-free attachment, AutoMod, channel-creation, channel-metadata, forum-post, guild-expression, invite-deletion, onboarding-change, scheduled-event, scaffold-step, member-role, role-creation, role-configuration, message-pin, poll-creation, poll-ending, webhook-deletion, permission-overwrite, deletion, interaction, and member-moderation activity |
