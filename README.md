...
| Guild structure | Four deterministic public starter layouts, custom authoring, and two-pass capture into caller-retained guild blueprints across additive structure, exact-ID role and channel convergence, profile, settings, monotonic Community, complete Welcome Screens and onboarding, staged AutoMod, and ordered restart-verifiable static Components V2 publications; additive channels and roles; reviewed exact channel and standard-role retirement; resumable scaffolds; atomic channel cloning; relative channel placement within or across categories and relative role ordering; boost-aware voice and Stage channel metadata; connection-sensitive voice-channel status changes; exact permission overwrites and reviewed parent-category permission synchronization; forum tags; and exact role configuration with reviewed local or Unicode icons |
