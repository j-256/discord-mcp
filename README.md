...
| Messages and communities | Idempotent guild and webhook delivery; reviewed exact-recipient private messages; restart-verifiable Components V2 with callback-free links or authenticated private-request Buttons; remote-free embeds; attachments and transient reads; pins, reactions, crossposts, subscriptions, forwarding, forums, threads, guided create-inspect-end native polls, and exact deletion |
