...
| --- | --- |
| Discovery and reads | Local exact-ID conversion from jump links and typed mentions, guilds, channels, exact allowlisted one-to-one private messages, voice regions and transient channel status, roles, effective permissions, member-safe audits, message history, search, privacy-safe aggregate activity, threads, forums, polls, reactions, audit history, integrations, invites, templates, guild and application-owned emojis, stickers, soundboard, events, Stage instances, onboarding, Welcome Screens, profiles, settings, Community routing, incident actions, and channel webhooks |
