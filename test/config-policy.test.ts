...
test("configuration and policy isolate reviewed guild settings", () => {
  ...
  assert.throws(
    ...
    /Permission-aware guild features require/,
  )
  assert.throws(
    () => loadConnectorConfig({
      DISCORD_BOT_TOKEN: TOKEN,
...
test("configuration and policy isolate reviewed guild profile text", () => {
  ...
  assert.throws(
    ...
    /requires DISCORD_MCP_ALLOW_GUILD_PROFILE_AUDIT/,
  )
  assert.throws(
    () => loadConnectorConfig({
      DISCORD_BOT_TOKEN: TOKEN,
    ...
    /requires DISCORD_MCP_GUILD_PROFILE_GUILD_IDS/,
  )
  assert.throws(
    () => loadConnectorConfig({
      DISCORD_BOT_TOKEN: TOKEN,
    ...
    /DISCORD_MCP_GUILD_PROFILE_GUILD_IDS must be a subset/,
  )
  assert.throws(
    () => loadConnectorConfig({
      DISCORD_BOT_TOKEN: TOKEN,
...
test("configuration and policy separate reviewed channel-deletion audit from execution", () => {
  assert.throws(
    ...
    /requires DISCORD_MCP_ALLOW_CHANNEL_DELETION_AUDIT/,
  )
  assert.throws(
    () => loadConnectorConfig({
      DISCORD_BOT_TOKEN: TOKEN,
    ...
    /requires DISCORD_MCP_CHANNEL_DELETION_IDS/,
  )
  assert.throws(
    () => loadConnectorConfig({
      DISCORD_BOT_TOKEN: TOKEN,
